## ---------------------------------------------------------- ##
## Função do R que desenha um sombreado sob uma curva normal  ##
## ---------------------------------------------------------- ##
## Tony Cookson                                               ##
## http://novicemetrics.blogspot.com/2011/04/computing-       ##
## ---------------------------------------------------------- ##

shadenorm = function(below=NULL, above=NULL, pcts = c(0.025,0.975), mu=0, sig=1, numpts = 500, color = "gray", dens = NULL,
  ...
  if(lines==FALSE){
    plot(x.grid, dens.all, type="l", xlab="X", ylab="Densidade")
  }
